...
<template>
	<PageLink url="/panel/profil" :title="$t('Avatar')" :description="$t('Add or update your avatar.')">
		<i class="fa-regular fa-user"></i>
	</PageLink>
	<PageLink url="/panel/profil/details" :title="$t('Details')" :description="$t('Add or update your details.')">
