			...
			<div class="form-wraper">
				<form @submit.prevent="onSubmit" class="form-auth" id="registerForm">
					...
					<Input
						...
						name="name"
						v-model="name"
						:placeholder="$t('register.Name_eg')"
					...
					<Input
						...
						name="email"
						v-model="email"
						:placeholder="$t('register.Email_address_eg')"
					...
					<Password
						...
						name="password"
						v-model="password"
						:placeholder="$t('register.Password_eg')"
					...
					<Password
						...
						:placeholder="$t('register.Confirm_password_eg')"
					...
					<div class="full">
						<button class="button" :title="$t('register.Register')" :disabled="!confirm_services">
							{{ $t('register.Register') }}
						</button>
					</div>
