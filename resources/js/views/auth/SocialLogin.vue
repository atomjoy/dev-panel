<template>
	<div class="social-login-buttons">
		<a href="/oauth/google/redirect" title="{{ $t('login.Sign_In_Google') }}">
		...
		<a href="/oauth/github/redirect" title="{{ $t('login.Sign_In_Github') }}">
			<div class="social-login-btn social-github-btn">
				<i class="fa-brands fa-github"></i>
				<span> {{ $t('login.Sign_In_Github') }} </span>
			</div>
		</a>
		<div class="social-login-buttons-text">
			<span>{{ $t('login.Sign_In_Or') }}</span>
		</div>
	</div>
</template>
